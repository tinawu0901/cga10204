        ...
        <div class="row align-items-end ">
          <div class="col-lg-5">
            ...
            <div class="intro">
              ...
              <a href="${pageContext.request.contextPath}/event/eventShowList">活動列表</a>
              <span class="mx-2">/</span>
              <strong>活動詳細資訊</strong>
              </div>
            </div>
  ...
  <div class="site-section bg-light"> 
   ...
   <div class="container-fluid" style="width: 80%; height: 60%;">
			<div class="row justify-content-center text-center">
				<div class="col-12">
					<div style="background-color: #FFF3EE; height: 80%">
						<h1 class="" style="text-align: center; margin-bottom: 50px; padding-top:20px; font-weight: 900; color: #F75000;">${requestScope.eventObject.event_title}</h1>
						<div class="" style="display: flex; justify-content:space-around;">
							...
							<div class="" style="margin-right: 120px;  margin-top: 15px;">
								<ul style="font-size: 22px; width: 100%; list-style: none; font-weight: 900; text-align: justify; text-justify: inter-character;">
										<li>一、優惠期間：<br>${requestScope.eventObject.event_start} ~
											${requestScope.eventObject.event_end}，以用車時間為準。</li>
										<li>二、預約方式：<br>於活動期間內，線上預約，即享優惠方案價。</li>
										 <c:choose>
											<c:when test="${requestScope.eventObject.model_no eq '全部'}">
										<li>三、優惠內容：<br>本活動指定車型為全部，折扣${fn:substring(requestScope.eventObject.event_discount,1,-1)}。</li>
											</c:when>
											<c:otherwise>
										<li>三、優惠內容：<br>本活動指定車型為${requestScope.eventObject.model_no}，折扣${fn:substring(requestScope.eventObject.event_discount,1,-1)}。</li>
											</c:otherwise>
										</c:choose>
								</ul>
							</div>
						...
						<br>
						<br>
						<p class="" style="font-size: 22px; width:950px; margin-left: 120px; text-align: justify; text-justify: inter-character; ">${requestScope.eventObject.event_content}</p>
						<br>
						<br>
						<a href="${pageContext.request.contextPath}/front_end/rcar_order/makeOrder.jsp" style="display: block; margin: 0px auto; width: 50%;" class="btn btn-primary btn-lg">預約租車</a>
					</div>
					<br>
					<br>
					<br>
					...
					<p
						style="color: aliceblue; background-color: gray; opacity: 0.8; font-size: 20px;text-align:center; text-justify: inter-character;">
						注意事項：本活動指定車型為
						<c:choose>
