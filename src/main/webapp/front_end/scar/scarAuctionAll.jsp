...
<body>
			...
			<div class='divunder'>
				...
				<div class='divr'>
					...
					<form class='formdetail' action="${pageContext.request.contextPath}/scar/scarAuctionDetail">
						...
						<input type="submit" id="submitx" value="立即競拍" class="btn btn-warning inpdetail${scar.scar_status}" style="font-size: 15px; color: white; background-color: #FFA042; font-weight: 900; border-radius: 10px; width: 90%;">
	...
	<script>
		...
		let inpdetail0 = document.querySelectorAll('.inpdetail0');
		
		for(let i of inpdetail0){
