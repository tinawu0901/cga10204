...
<body>
    ...
    <main class="main">
		...
		<div class="container" style="width: 95%;">
			<h1 style="margin-bottom: 0px;font-size: 2rem;padding-left: 0px;">編輯中古車</h1>
			<div class="row justify-content-center text-center">
		
				<div class="col-9 ">				
					<form id="scareditform">
						<div class="row  justify-content-center">
						
							<div class="col-6">
								<div class="d-flex flex-row" style="font-size: 18px">
								<label for="event_title">中古車輛編號</label>
								</div>
								<div class="input-group ">
									<input type="text" style="height: 10%;color:#CCCCCC" class="form-control"
										id="scar_no" name="scar_no" value="${scar.scar_no}" readonly >
								</div>
							</div>
						...
						<div class="row  g-1  justify-content-center">
							...
							<div class="col-4">
									<div class="d-flex flex-row" style="font-size: 18px">
								<label for="scar_year">中古車年分</label>&emsp;
					...
					<div class="d-flex flex-row" style="font-size: 18px">
								...
								<div class="input-group">
									<input type="text" style="height: 10%;" class="form-control"
										id="scar_cc" name="scar_cc" value="${scar.scar_cc}"  required>
								</div>
							</div>
						</div>
						...
						<div class="row g-1 justify-content-center ">
							...
							<div class="col-4">
								...
								<div class="input-group">
									<input type="text" style="height: 10%;" class="form-control"
										id="scar_fuel" name="scar_fuel" value="${scar.scar_fuel}" required>
								</div>
							</div>
							<div class="col-4">
								...
								<div class="input-group">
									<input type="number" style="height: 10%;" class="form-control"
										id="scar_miles" name="scar_miles" value="${scar.scar_miles}" required>
								</div>
							</div>
							...
							<div class="d-flex flex-row" style="font-size: 18px;font-weight: normal;">
								...
								<div class="input-group">
									<input type="text" style="height: 10%;" class="form-control"
										id="scar_startime" name="scar_startime" value="<fmt:formatDate value="${scar.scar_startime}" pattern="yyyy-MM-dd HH:mm:ss"/>" required>
								</div>
							</div>
							<div class="col-6 ">
						<div class="d-flex flex-row" style="font-size: 18px">
								...
								<div class="input-group">
									<input type="text" style="height: 10%;" class="form-control"
										id="scar_endtime" name="scar_endtime" value="<fmt:formatDate value="${scar.scar_endtime}" pattern="yyyy-MM-dd HH:mm:ss"/>" required>
								</div>
							</div>
						</div>
					...
					<div class="row g-1 justify-content-center ">
						<div class="col-6">
							...
							<div class="input-group">
								<input type="number" style="height: 10%;" class="form-control"
									id="scar_price" name="scar_price" min="10000" value="${scar.scar_price}" step="5000"
									required>
							</div>
						</div>
				...
				<div class="d-flex flex-row" style="font-size: 18px;">
					...
					<div class="col-3  mx-auto" style="font-size: 18px">
							<label for="scar_photo">車輛照片</label> <br> <img id="frame"
								src="${pageContext.request.contextPath}/allImages?scar_no=${scar.scar_no}"  style="width: 325px; height: 300px;" />
	...
	<script>
		         ...
		         const st_no = document.getElementById("st_no");
	                fetch('/CGA102G4/Getstoreall', { method: 'GET', })
	                    .then(function (response) {
	                        ...
	                        for (let l of list) {
	                        	if(l.st_no !== "TPEHO"){
	    	                        const st_no_startSelected = '${scar.st_no}';
		...
		// }
		 ...
		 $('#sub').click(function () {
            let passFrom = document.getElementById("scareditform");
            let pform = new FormData(passFrom);
            $('.msg').empty();
            $.ajax({
                type: "POST",
                url: "${pageContext.request.contextPath}/scar/scarEdit",
                data: pform,
