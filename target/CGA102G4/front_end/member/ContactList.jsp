        ...
        <div class=" align-items-center logo">
          ...
          <nav class="site-navigation text-right ml-auto d-none d-lg-block" role="navigation">
            <ul class="site-menu main-menu js-clone-nav ml-auto ">
              ...
              <li>
                <a href="<%=request.getContextPath()%>/scar/scarAuctionAll" class="nav-link menuStyle" id="dropdownMenuLink" role="button" style="padding-bottom: 0px;">中古車</a>
              </li>
        ...
        <div class="row align-items-end ">
          <div class="col-lg-5">
            ...
            <div class="intro">
              ...
              <div class="custom-breadcrumbs"><a href="<%= request.getContextPath()%>/index">首頁</a> <span class="mx-2">/</span>
                <strong>聯絡我們</strong>
              </div>
            </div>
        ...
        <div class="col-lg-8 mb-5" >
          <form id="test">
            ...
            <div class="form-group row">
              <div class="col-md-12" style="margin-top: 20px;">
               <p>問題描述*</p>
                <textarea name="issue_content"  class="form-control"  placeholder="請留下您的寶貴意見!" cols="30" rows="10" style="resize: none; height: 150px;"></textarea>
              </div>
            </div>
            <div class="form-group row">
