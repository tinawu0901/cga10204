				...
				<div class=" align-items-center logo">
					...
					<nav class="site-navigation text-right ml-auto d-none d-lg-block"
						...
						<ul class="site-menu main-menu js-clone-nav ml-auto ">
							...
							<li id="ch"> <a href="${pageContext.request.contextPath}/front_end/rcar_order/makeOrder.jsp" class="nav-link menuStyle" role="button" style="padding-bottom: 0px;">租車</a></li>
			...
			<div class="customer_info">
				...
				<div class="div_start_store right_side">
					<label for="">起租站點:</label><br> <select name="start_store"
						id="" disabled>
						<option value="${rcar_OrderVO.rcaro_pickuploc}">${rcar_OrderVO.rcaro_pickuploc}</option>
					</select>
				</div>
				...
				<div class="div_return_store left_side">
					<label for="">歸還站點:</label><br> <select name="return_store"
						id="" disabled>
						<option value="${rcar_OrderVO.rcaro_returnloc}">${rcar_OrderVO.rcaro_returnloc}</option>
					</select>
				</div>
				...
				<div class="div_real_return_store right_side">
					<label for="">實際歸還站點:</label><br> <select
						...
						<option value="${rcar_OrderVO.rcaro_returnloc_actual}">${rcar_OrderVO.rcaro_returnloc_actual}</option>
					</select>
				</div>
