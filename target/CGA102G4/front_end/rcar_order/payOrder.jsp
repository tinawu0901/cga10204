...
<!-- 								</ul> -->
	...
	<div class="site-section bg-light" style="position: relative;">
		...
		<div class="container"
			style="width: 1200px; height: 1000px; background-color: white; font-size: 20px;">
			<div class="order_container">
				
				<div class="order_info">
					<div class="order_inner">
						<label>車種:</label> ${param.car_level} <br>
					</div>

					<div class="order_inner order_inner_1">
						<label>起租站點:</label> ${param.start_store}<br>
					</div>

					<div class="order_inner order_inner_1">
						<label>歸還站點:</label> ${param.return_store}<br>
					</div>

					<div class="order_inner order_inner_1">
						<label>取車時間:</label> ${param.order_car_time}<br>
					</div>

					<div class="order_inner order_inner_1">
						<label>還車時間:</label> ${param.order_return_car_time}<br>
					</div>
					
					<div class="order_inner order_inner_1">
						<label>駕駛人姓名:</label> ${param.lessee_name}<br>
					</div>
				...
				<div class="car_model" >
					<div>
						...
						<img src="${pageContext.request.contextPath}/CarModel/CarModelPictureServlet?car_model=${param.car_model}"
						style="width: 100%;">
					</div>
				</div>
...
<!-- 			<div class="div_payment_info" style="border: 1px solid pink;"> -->
				<form
					...
					<div class="money_div">
						...
						<div class="event_div">
							<label>活動優惠</label><br>
							<div style="color: green; font-weight: bold">${requestScope.eventTitle}</div>
						</div>
